...
def contains_personal_information(cookie):
    ...
    demographic_keywords = ['gender', 'income', 'demographic']
...
for region in ['ca', 'eu', 'uk', 'au', 'us', 'sg', 'can', 'za']:
    ...
    # print('{}, omit: {}'.format(region, size_omit2 / size_omit1))
    # print('{}, incorrect: {}'.format(region, size_incorrect2 / size_incorrect1))
    # print('{}, ambiguous: {}'.format(region, size_ambiguous2 / size_ambiguous1))
    # print('{}, comply: {}'.format(region, size_comply2 / size_comply1))
        print('{}, {}, ip_address: {}'.format(region, i, size_ip))
        print('{}, {}, location: {}'.format(region, i, size_location))
        print('{}, {}, tracker: {}'.format(region, i, size_tracker))
        print('{}, {}, demographic: {}'.format(region, i, size_demographic))
        print('{}, {}, none: {}'.format(region, i, size_none))
